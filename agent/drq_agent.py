...
class DeepMDPAgent(object):
    ...
    def update(self, replay_buffer, L, step):
        ...
        obs = augmentations.random_shift(obs, pad=4)
        next_obs = augmentations.random_shift(next_obs, pad=4)


        #obs[0] = augmentations.random_shift(obs[0], pad=4)
        #next_obs[0] = augmentations.random_shift(next_obs[0], pad=4)
